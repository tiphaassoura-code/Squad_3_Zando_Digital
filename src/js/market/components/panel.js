  ...
  root.innerHTML = `
    ...
    <div class="panel-body">
      <div class="panel-media">
        <img src="${product.image}" alt="${product.name} de ${producer.name ?? producer.contact}, ${product.city}" decoding="async">
      </div>
      ...
      <div>
        ...
        <div class="producer-card">
          ...
          <div class="producer-info">
            <p class="producer-name">${producer.name ?? producer.contact} ${producer.verified ? icon("badge-check") : ""}</p>
...
export function openPanel(productId, { focus = true } = {}) {
  ...
  if (focus)
    root.querySelector("[data-close-panel]")?.focus({ preventScroll: true });
}
